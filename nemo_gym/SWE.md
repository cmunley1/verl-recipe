...
3. Clone `cmunley1/verl` (fork of `verl-project/verl`), checkout branch `cmunley/swe-nemogym-recipe`. The recipe submodule will be on branch `cmunley/swe-nemogym-recipe` of `cmunley1/verl-recipe`.
